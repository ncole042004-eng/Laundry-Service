...
('LS-260625-003',
    ...
    3, 1, '2026-06-25 11:00:00', NULL, NULL,
...
('LS-260626-001',
    ...
    4, 1, '2026-06-26 08:15:00', NULL, NULL,
...
('LS-260626-002',
    ...
    5, 1, '2026-06-26 10:00:00', NULL, NULL,
...
('LS-260626-003',
    ...
    6, 1, '2026-06-26 13:00:00', NULL, NULL,
...
('LS-260627-001',
    ...
    7, 1, '2026-06-27 08:00:00', '2026-06-27 14:00:00', NULL,
...
('LS-260627-003',
    ...
    2, 1, '2026-06-27 09:00:00', '2026-06-27 15:00:00', NULL,
...
('LS-260627-004',
    ...
    3, 1, '2026-06-27 11:00:00', '2026-06-27 17:00:00', NULL,
...
('LS-260628-001',
    ...
    4, 1, '2026-06-28 07:30:00', '2026-06-28 12:30:00', '2026-06-28 18:00:00',
    4.00, 175.0000, 175.0000, 'Paid', 'Claimed', NULL),

-- Claimed / Paid — taken by Nics
('LS-260628-002',
    (SELECT customer_id FROM Customers WHERE phone = '09171234501'),
    5, 1, '2026-06-28 08:00:00', '2026-06-28 13:00:00', '2026-06-28 17:00:00',
    4.50, 175.0000, 175.0000, 'Paid', 'Claimed', NULL),

-- Claimed / Paid — taken by Rodzkie
('LS-260628-003',
    (SELECT customer_id FROM Customers WHERE phone = '09281234502'),
    6, 1, '2026-06-28 09:00:00', '2026-06-28 14:00:00', '2026-06-29 09:00:00',
    6.00, 175.0000, 175.0000, 'Paid', 'Claimed', 'Handle with care'),

-- Claimed / Paid — taken by Jai
('LS-260629-001',
    (SELECT customer_id FROM Customers WHERE phone = '09391234503'),
    7, 1, '2026-06-29 08:00:00', '2026-06-29 13:30:00', '2026-06-29 16:00:00',
...
('LS-260629-003',
    (SELECT customer_id FROM Customers WHERE phone = '09171234504'),
    2, 1, '2026-06-29 10:00:00', '2026-06-29 16:00:00', '2026-06-30 11:00:00',
    7.00, 175.0000, 175.0000, 'Paid', 'Claimed', 'No fabric softener'),

-- Claimed / Paid — taken by Imeaa
('LS-260630-001',
    (SELECT customer_id FROM Customers WHERE phone = '09281234505'),
    3, 1, '2026-06-30 07:45:00', '2026-06-30 13:00:00', '2026-06-30 15:30:00',
    5.00, 175.0000, 175.0000, 'Paid', 'Claimed', NULL),

-- Claimed / Paid — taken by Iyah
('LS-260630-002',
    (SELECT customer_id FROM Customers WHERE phone = '09171234507'),
    4, 1, '2026-06-30 08:30:00', '2026-06-30 14:00:00', '2026-06-30 17:00:00',
    2.50, 175.0000, 175.0000, 'Paid', 'Claimed', 'Separate darks'),

-- Claimed / Paid — taken by Nics
('LS-260630-003',
    (SELECT customer_id FROM Customers WHERE phone = '09281234508'),
    5, 1, '2026-06-30 09:15:00', '2026-06-30 15:00:00', '2026-07-01 09:00:00',
    6.50, 175.0000, 175.0000, 'Paid', 'Claimed', NULL),

-- Claimed / Paid — taken by Rodzkie
('LS-260630-004',
    (SELECT customer_id FROM Customers WHERE phone = '09391234509'),
    6, 1, '2026-06-30 10:00:00', '2026-06-30 16:00:00', '2026-07-01 10:30:00',
